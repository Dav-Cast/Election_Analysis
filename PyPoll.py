...
# Declare list for the candidates.
candidate_options = []

#Declare a dictionary for the votes for each candidate.
candidate_votes = {}
...
with open(file_to_load) as election_data:
     ...
     for row in file_reader:
         ...
         # Print the candidte name from each row
         candidate_name = row[2]

         # Check if the candidate does not match any existing candidate
         if candidate_name not in candidate_options:

            # Add the candidate name to the options list.
...
#4. The total number of votes esch candidate won
#5. The winner of the elecition based on popular vote
